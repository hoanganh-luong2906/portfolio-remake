      ...
      <div className="reveal" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        {D.testimonials.map((t, i) => (
          <figure
            key={i}
            className="glass"
            style={{ padding: 36, margin: 0, display: 'flex', flexDirection: 'column', gap: 28 }}
          >
            <svg width="32" height="24" viewBox="0 0 32 24" fill="var(--accent)" style={{ opacity: 0.7 }}>
            ...
            <p style={{ margin: 0, fontSize: 22, lineHeight: 1.55, fontWeight: 500, letterSpacing: '-0.005em' }}>
              &ldquo;{t.quote}&rdquo;
            </p>
            <figcaption
              style={{
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: 'var(--fg-muted)' }}>{t.title}</div>
              </div>
            </figcaption>
          </figure>
        ))}
