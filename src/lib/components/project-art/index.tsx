  ...
  return (
    ...
    >
      ...
      {Array.from({ length: 16 }).map((_, i) => (
        <line key={i} x1={i * 50} y1="0" x2={i * 50} y2="500" stroke="rgba(255,255,255,0.04)" />
      ))}
      {Array.from({ length: 10 }).map((_, i) => (
        <line key={i} x1="0" y1={i * 50} x2="800" y2={i * 50} stroke="rgba(255,255,255,0.04)" />
      ))}
      <g transform="translate(60, 320)">
        <rect x="0" y="0" width="680" height="32" rx="6" fill="rgba(255,255,255,0.05)" />
        <rect x="20" y="6" width="180" height="20" rx="4" fill="url(#loomLime)" opacity="0.95" />
        <rect x="220" y="6" width="120" height="20" rx="4" fill="rgba(232,255,92,0.4)" />
        <rect x="0" y="44" width="680" height="32" rx="6" fill="rgba(255,255,255,0.05)" />
        <rect x="60" y="50" width="240" height="20" rx="4" fill="rgba(255,255,255,0.55)" />
        <rect x="320" y="50" width="80" height="20" rx="4" fill="rgba(255,255,255,0.25)" />
        <rect x="0" y="88" width="680" height="32" rx="6" fill="rgba(255,255,255,0.05)" />
        <rect x="100" y="94" width="320" height="20" rx="4" fill="rgba(232,255,92,0.7)" />
      </g>
      <g>
        <line x1="280" y1="40" x2="280" y2="460" stroke="#E8FF5C" strokeWidth="1.5" />
      ...
      <g transform="translate(60, 60)">
        <rect width="100" height="26" rx="6" fill="rgba(232,255,92,0.15)" stroke="rgba(232,255,92,0.4)" />
        <text
          x="50"
          y="17"
          textAnchor="middle"
  ...
  return (
    ...
    >
      ...
      <g transform="translate(80, 80)">
        ...
        />
        <rect x="280" y="0" width="120" height="40" rx="20" fill="rgba(255,179,122,0.20)" stroke="#FFB37A" />
        <rect
          x="420"
          y="0"
          width="120"
        ...
        />
        <rect x="14" y="76" width="80" height="12" rx="3" fill="rgba(255,255,255,0.45)" />
        <rect x="280" y="60" width="260" height="44" rx="10" fill="rgba(255,255,255,0.05)" stroke="#FFB37A" />
        <rect x="294" y="76" width="120" height="12" rx="3" fill="#FFB37A" />
        <g transform="translate(0, 130)">
          <rect width="260" height="170" rx="14" fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.10)" />
          <circle cx="40" cy="40" r="22" fill="#FFB37A" />
          <rect x="76" y="28" width="120" height="10" rx="2" fill="rgba(255,255,255,0.7)" />
          <rect x="76" y="46" width="80" height="8" rx="2" fill="rgba(255,255,255,0.30)" />
          <rect x="20" y="84" width="220" height="6" rx="2" fill="rgba(255,255,255,0.15)" />
          <rect x="20" y="98" width="180" height="6" rx="2" fill="rgba(255,255,255,0.15)" />
          <rect x="20" y="112" width="200" height="6" rx="2" fill="rgba(255,255,255,0.10)" />
          <rect x="20" y="138" width="80" height="22" rx="6" fill="#FFB37A" />
        </g>
        <g transform="translate(280, 130)">
          <rect width="260" height="170" rx="14" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" />
          <text
            x="20"
            y="34"
          ...
          {(
            ...
            <g key={i} transform={`translate(20, ${50 + i * 22})`}>
              ...
              <text x="30" y="11" fill="rgba(255,255,255,0.55)" fontSize="10" fontFamily="ui-monospace, monospace">
                {name}
              </text>
              <text x="180" y="11" fill="rgba(255,255,255,0.30)" fontSize="9" fontFamily="ui-monospace, monospace">
                {color.toUpperCase()}
              </text>
            </g>
          ))}
  ...
  return (
    ...
    >
      ...
      {(
        ...
        <g key={i}>
          <rect x={x - 5} y={y - 5} width="10" height="10" fill="#0e1620" stroke="#7AB8FF" strokeWidth="1.5" />
        </g>
      ))}
      <g transform="translate(420, 200)">
        <circle r="10" fill="#7AB8FF" opacity="0.25">
          {animated && <animate attributeName="r" values="10;22;10" dur="2.5s" repeatCount="indefinite" />}
        </circle>
        <circle r="6" fill="#7AB8FF" />
      </g>
      <g transform="translate(60, 60)">
        <rect width="160" height="28" rx="6" fill="rgba(255,255,255,0.06)" stroke="rgba(122,184,255,0.4)" />
        <text x="14" y="18" fill="#7AB8FF" fontSize="11" fontFamily="ui-monospace, monospace">
          40.7128° N · 74.0060° W
        </text>
      </g>
      <g transform="translate(560, 380)">
        <path d="M0,0 L0,20 L6,15 L10,22 L13,20 L9,13 L16,12 Z" fill="#fff" stroke="#0e1620" strokeWidth="0.5" />
      </g>
    </svg>
  );
}
    ...
    >
      ...
      {Array.from({ length: 6 }).map((_, row) =>
        Array.from({ length: 10 }).map((_, col) => {
          ...
          return (
            <g key={`${row}-${col}`} transform={`translate(${x}, ${y}) rotate(${rotate} 40 35)`}>
              <path d="M0,35 Q40,0 80,35 Q40,70 0,35 Z" fill="url(#tesRose)" opacity={opacity} />
            </g>
          );
        }),
      )}
      <g transform="translate(280, 160)">
        <rect width="240" height="180" rx="8" fill="rgba(0,0,0,0.5)" stroke="rgba(255,122,158,0.6)" />
        <path d="M0,90 Q120,0 240,90 Q120,180 0,90 Z" fill="url(#tesRose)" opacity="0.85" />
        <text
          x="120"
          y="105"
          textAnchor="middle"
      ...
      {animated && (
        <g>
          <circle cx="120" cy="80" r="3" fill="#FF7A9E">
            <animate attributeName="cy" values="80;420;80" dur="9s" repeatCount="indefinite" />
          </circle>
        </g>
      )}
    </svg>
  ...
  return (
    ...
    >
      ...
      {labels.map((label, i) => {
        ...
        return (
          <g key={i} transform={`translate(80, ${y})`}>
            <text x="0" y="14" fill="rgba(255,255,255,0.78)" fontSize="13" fontFamily="ui-monospace, monospace">
              {label}
            </text>
            <text x="640" y="14" fill="#7AFFB8" fontSize="11" fontFamily="ui-monospace, monospace" textAnchor="end">
              100.00%
            </text>
            <g transform="translate(0, 26)">
              {Array.from({ length: segments }).map((_, s) => {
                const isDown = (i === 1 && s === 24) || (i === 3 && (s === 8 || s === 9));
      ...
      <g transform="translate(80, 40)">
        ...
        <text x="20" y="11" fill="#fff" fontSize="13" fontFamily="ui-monospace, monospace" letterSpacing="2">
